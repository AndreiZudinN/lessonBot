...
const anyElementInFirstIsOdd = firstArray.some(array => array % 2);

const anyElementInSecondIsEven = secondArray.some(array => array % 2 === 0);
const anyElementInSecondIsOdd = secondArray.some(array => array % 2);

const anyElementInThirdIsEven = thirdArray.some(array => array % 2 === 0);
const anyElementInThirdIsOdd = thirdArray.some(array => array % 2);
